...
% $Revision: 1.5.4.9 $  $Date: 2005/07/26 10:23:15 $
...
% sampling mode
block.SampleTimes = [0 0]; %Port-based sample time
...
if isfield(block_data, 'hfig') && ~isempty(block_data.hfig)
  ...
  if curpos ~= block.DialogPrm(9).Data
...
% ---------------------------------------------------------------
function fig_data = create_scope(block, u)
...
% ---------------------------------------------------------------
function FigDelete(hco, eventStruct)
...
% ---------------------------------------------------------------
function SaveFigPos(hco, eventStruct)
...
% ---------------------------------------------------------------
function AxisColorbar(hco, eventStruct)
...
% ---------------------------------------------------------------
function AxisZoom(hco, eventStruct)
...
% ---------------------------------------------------------------
function Autoscale(hco, eventStruct)
...
if nargin == 2
    ...
    % Put up an autoscale indicator: xxx HUH?
...
% ---------------------------------------------------------------
function FigRefresh(hco, eventStruct)
